...
<body x-data class="h-screen mx-auto antialiased flex justify-between">
    ...
    <div class="h-screen bg-gray-900 transition-all duration-300 space-y-2 fixed sm:relative flex justify-around  flex-col"
        x-bind:class="{
        ...
        <div>
            <h1 class="text-white font-black py-4"
                x-bind:class="$store.sidebar.full ? 'text-2xl px-4' : 'text-xl px-4 xm:px-2'">Haque Store</h1>
        </div>
        <div class="px-4 space-y-2">
            ...
            <div class="h-[70vh]  scrollbar scrollbar-thumb-gray-900  scrollbar-thin scrollbar-track-transparent"
                ...
                <a href="{{ route('company.user.list') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.user.list' ? 'text-gray-200 bg-gray-800' : '' }}
                ...
                <!-- Customer -->
                <a href="{{ route('company.customer.list') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.customer.list' ? 'text-gray-200 bg-gray-800' : '' }}
                ...
                <!-- Products -->
                <a href="{{ route('company.product.list') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.product.list' ? 'text-gray-200 bg-gray-800' : '' }}
                ...
                <!-- Invoices -->
                <a href="{{ route('company.invoice.list') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.invoice.list' ? 'text-gray-200 bg-gray-800' : '' }}
                ...
                <!-- Invoices -->
                <a href="{{ route('company.stocklist') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.stocklist' ? 'text-gray-200 bg-gray-800' : '' }}
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 8.25.22-.22a.75.75 0 0 1 1.28.53v6.441c0 .472.214.934.64 1.137a3.75 3.75 0 0 0 4.994-1.77c.205-.428-.152-.868-.627-.868h-.507m-6-2.25h7.5M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                ...
                <a href="{{ route('company.roles.list') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.roles.list' || Route::currentRouteName() == 'company.roles.create' || Route::currentRouteName() == 'company.roles.edit' ? 'text-gray-200 bg-gray-800' : '' }}
                    ">
                ...
                <!-- Role and permissions -->
                <a href="{{ route('company.user.profile') }}" x-data="tooltip" x-on:mouseover="show = true"
                    x-on:mouseleave="show = false"
                    class="relative flex items-center hover:text-gray-200 hover:bg-gray-800 space-x-2 rounded-md p-2 cursor-pointer justify-start text-gray-400
                    {{ Route::currentRouteName() == 'company.user.profile' ? 'text-gray-200 bg-gray-800' : '' }}
                    ">
                        ...
                        <div x-data="sub_dropdown" class="relative w-full ">
                            ...
                            <div x-show="sub_open" @click.outside="sub_open = false"
                                ...
                                <a href="{{ route('pages.blank') }}"
                                    class="hover:text-gray-200 cursor-pointer ">Blank</a>
