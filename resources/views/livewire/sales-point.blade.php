                               ...
                               <div>
                                   @if ($activeInvoice?->customer && $activeInvoice->customer->balance >= 0)
                                       <span
                                           ...
                                           <p class="text-sm whitespace-nowrap">{{ $activeInvoice?->customer && $activeInvoice->customer->balance }}
                                           </p>
               ...
               <div
                   ...
                   <div class="mt-4">
                       @if ($settledinvoiceId != null)
                           <div>
                               <div role="alert"
                                   class="rounded-md border border-green-500 bg-green-50 p-4 shadow-sm">
                               ...
                               <div class="grid gap-1">
                                   ...
                                   <div class="flex gap-4">
                                       <label class="flex items-center cursor-pointer">
                                           <input class="border border-transparent checked:border-gray-300"
                                               type="radio" value="full_paid" wire:model.live="radio">
